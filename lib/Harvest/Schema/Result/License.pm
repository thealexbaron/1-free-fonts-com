use utf8;
package Harvest::Schema::Result::License;
...
__PACKAGE__->add_columns(
  ...
  "name",
  { data_type => "char", is_nullable => 1, size => 85 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QBKh7HMbMnRdNWnzxgSMDQ
